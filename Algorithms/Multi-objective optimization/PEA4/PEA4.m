        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(A1)
                ...
                if stage == 0
                    ...
                    PopNew = NewSelect1(PopDec,PopObj,[],ObjMSE,[],A2,mu,Problem,stage);
                else
                    ...
                    PopNew = NewSelect1(PopDec,PopObj,PopCon,ObjMSE,ConMSE,A2,mu,Problem,stage);
                end
                ...
                if isempty(PopNew) == 0
                    ...
                    % minQ1 = min(Q1(:));
                    % minQ2 = min(Q2(:));
                    % minQ1_history = [minQ1_history; minQ1];
                    % minQ2_history = [minQ2_history; minQ2];
                    %%%
                    A2             = [A2,PopNew];
                ...
                % disp(Problem.FE);
                if Problem.FE >= 300
                   Q_history = [minQ1_history, minQ2_history];
                   assignin('base', 'Q_history', Q_history);
                end
            end 
        end
    end
