function PopNew = NewSelect(PopDec,PopObj,PopCon,ObjMSE,ConMSE,A1,mu,Problem,stage)
    %% Preparing Data
    ...
    ObjMSE = ObjMSE./(max(zmax - zmin,10e-10).^2);%？？？ 这个归一化不是扯淡吗
    ...
    elseif stage == 0 
        [FrontNo,MaxFNo] = UNDSort(PopObj,ObjMSE,mu);
    end
    Next = FrontNo < MaxFNo;
