        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Archive)
              ...
              %% Build GP model for constraints
               GPmodels_con = cell(1,size(train_c,2)); 
               for i = 1 : size(train_c,2)
                   GPmodels_con{i} = Dacefit(train_x,train_c(:,i),'regpoly0','corrgauss',theta_c{i},1e-6*ones(1,Problem.D),20*ones(1,Problem.D));
