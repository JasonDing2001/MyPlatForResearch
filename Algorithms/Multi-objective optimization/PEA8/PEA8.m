...
%------------------------------- Copyright --------------------------------
% Copyright (c) 2021 BIMK Group. You are free to use the PlatEMO for新
    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(A1)
                ...
                % adaptive switching
                if r_coef < phi || Problem.FE >= 0.5 * Problem.maxFE
                    stage = 3;   %  Constrained surrogate-assisted evolutionary search
                else
                    if r_coef <  tau && Problem.FE < 0.5 * Problem.maxFE
                        stage = 2; 
                    else
                        stage = 1;
                    end
