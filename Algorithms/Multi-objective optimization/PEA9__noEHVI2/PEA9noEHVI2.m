classdef PEA9noEHVI2< ALGORITHM
        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(A1)
                ...
                elseif stage == 2
                    ...
                    PopNew = CNewSelect2(PopDec,PopObj,PopCon,ObjMSE,ConMSE,A1,A2,mu,Problem,stage);
                elseif stage == 3
                    [PopDec,PopObj,PopCon,ObjMSE,ConMSE] = Coptimization(A1,wmax,Model_obj,Model_con,Problem,stage);
                    % PopNew = CNewSelect(PopDec,PopObj,PopCon,ObjMSE,ConMSE,A1,A2,mu,Problem,stage);
                    PopNew = CNewSelect2(PopDec,PopObj,PopCon,ObjMSE,ConMSE,A1,A2,mu,Problem,ObjMSE);
                end
