    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(A2)
                ...
                if sample_success
                    [Model_obj,Model_con,THETA_obj,THETA_con] = model_train(A2,A1,THETA_obj,THETA_con);
                end
...
function [Model_obj,Model_con,THETA_obj,THETA_con] = model_train(A2,A1,THETA_obj,THETA_con)
    Dec = A2.decs;
    Obj = A2.objs;
    % Dec1 = A1.decs;
    Con = A2.cons;
